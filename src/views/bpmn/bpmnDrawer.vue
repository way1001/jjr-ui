...
export default {
  ...
  methods: {
    ...
    initCanvas: async function (xml, modelId, name, tenantId) {
      this.modelId = modelId
      this.deployName = name
      this.tenantId = tenantId
      var _this = this
      //
      // Passing callbacks to saveXML is deprecated and will be removed in a future major release.
    ...
    exportXML: async function () {
      ...
      try {
        ...
        if (_this.deployName !== '' && _this.deployName !== undefined && _this.deployName !== null) {
          ...
          _this.$emit('exportXML', xml,
            _this.deployName.indexOf('.bpmn20.xml') !== -1 ?_this.deployName : _this.deployName + '.bpmn20.xml',
            _this.tenantId)
          return
        }
        _this.$prompt('部署名称', '提示', {
